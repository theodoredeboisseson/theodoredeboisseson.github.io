            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-6 gap-4">
                ...
                >
                    ...
                    <div className="relative z-10 mt-auto">
                        <span className="text-2xl font-bold font-sans">Mon CV</span>
                        <p className="text-sm font-mono opacity-60 group-hover:opacity-80">Consulter le PDF</p>
                    </div>
                </motion.a>
                ...
                >
                    ...
                    <div>
                        ...
                        <p className="text-sm font-mono opacity-60 group-hover:opacity-80">Explorer mes projets</p>
                    </div>
                </motion.a>
                ...
                >
                    ...
                    <div>
                        ...
                        <p className="text-sm font-mono opacity-60 group-hover:opacity-80">Réseau professionnel</p>
                    </div>
                </motion.a>
